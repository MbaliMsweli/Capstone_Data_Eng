...
BEGIN
    ...
    INSERT INTO [RetailDataWarehouse].dbo.DimDate
    (
        DateKey,
        FullDate,
    ...
    SELECT
        CONVERT(INT, FORMAT(@StartDate,'yyyyMMdd')),   -- DateKey
        @StartDate,                                    -- FullDate

        CONVERT(INT, FORMAT(@StartDate,'yyyyMM')),     -- MonthID
        MONTH(@StartDate),                             -- Month number
        DATENAME(MONTH,@StartDate),                    -- Month name (January)
        ...
        DATENAME(WEEKDAY,@StartDate),                  -- Monday, Tuesday
